...
def main():
    # TEMPORARY DEBUG - remove once email sending works
    print(f"RESEND_API_KEY: len={len(RESEND_API_KEY)}, "
          f"starts={RESEND_API_KEY[:5]!r}, ends={RESEND_API_KEY[-4:]!r}")
    print(f"ANTHROPIC_API_KEY: len={len(ANTHROPIC_API_KEY)}, "
          f"starts={ANTHROPIC_API_KEY[:8]!r}")
